...
/**
 * Class epa_Stripe_Webhook_State.
 *
...
class Stripe_Webhook_State {
	const OPTION_LIVE_MONITORING_BEGAN_AT = 'epa_stripe_wh_monitor_began_at';
	const OPTION_LIVE_LAST_SUCCESS_AT     = 'epa_stripe_wh_last_success_at';
	const OPTION_LIVE_LAST_FAILURE_AT     = 'epa_stripe_wh_last_failure_at';
	const OPTION_LIVE_LAST_ERROR          = 'epa_stripe_wh_last_error';

	const OPTION_TEST_MONITORING_BEGAN_AT = 'epa_stripe_wh_test_monitor_began_at';
	const OPTION_TEST_LAST_SUCCESS_AT     = 'epa_stripe_wh_test_last_success_at';
	const OPTION_TEST_LAST_FAILURE_AT     = 'epa_stripe_wh_test_last_failure_at';
	const OPTION_TEST_LAST_ERROR          = 'epa_stripe_wh_test_last_error';
